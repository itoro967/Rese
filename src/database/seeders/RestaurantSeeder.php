    ...
    public function run(): void
    {
        $restaurants = [
            ...
            [
                ...
                'image_url' => asset('storage/restaurants/yakiniku.jpg'),
            ],
            [
                'name' => '戦慄',
                ...
                'image_url' => asset('storage/restaurants/izakaya.jpg'),
            ],
            [
                'name' => 'ルーク',
                'area_id' => $this->area['東京都'],
                ...
                'image_url' => asset('storage/restaurants/italian.jpg'),
            ],
            [
                'name' => '志摩屋',
                'area_id' => $this->area['福岡県'],
                ...
                'image_url' => asset('storage/restaurants/ramen.jpg'),
            ],
            [
                'name' => '香',
                'area_id' => $this->area['東京都'],
