...
class RestaurantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $restaurants = [
            [
                'name' => '仙人',
                'area_id' => $this->area['東京都'],
                'genre_id' => $this->genre['寿司'],
                'description' => '料理長厳選の食材から作る寿司を用いたコースをぜひお楽しみください。食材・味・価格、お客様の満足度を徹底的に追及したお店です。特別な日のお食事、ビジネス接待まで気軽に使用することができます。',
                'image_url' => 'storage/restaurants/sushi.jpg'
            ],
            [
                'name' => '牛助',
                'area_id' => $this->area['大阪府'],
                'genre_id' => $this->genre['焼肉'],
                ...
                'image_url' => 'storage/restaurants/yakiniku.jpg'
            ],
            [
                'name' => '戦慄',
                'area_id' => $this->area['福岡県'],
                'genre_id' => $this->genre['居酒屋'],
                'description' => '気軽に立ち寄れる昔懐かしの大衆居酒屋です。キンキンに冷えたビールを、なんと199円で。鳥かわ煮込み串は販売総数100000本突破の名物料理です。仕事帰りに是非御来店ください。',
                'image_url' => 'storage/restaurants/izakaya.jpg'
            ],
            [
                'name' => 'ルーク',
                'area_id' => $this->area['東京都'],
                'genre_id' => $this->genre['イタリアン'],
                'description' => '都心にひっそりとたたずむ、古民家を改築した落ち着いた空間です。イタリアで修業を重ねたシェフによるモダンなイタリア料理とソムリエセレクトによる厳選ワインとのペアリングが好評です。ゆっくりと上質な時間をお楽しみください。',
                'image_url' => 'storage/restaurants/italian.jpg'
            ],
            [
                'name' => '志摩屋',
                'area_id' => $this->area['福岡県'],
                'genre_id' => $this->genre['ラーメン'],
                ...
                'image_url' => 'storage/restaurants/ramen.jpg'
            ],
            [
                'name' => '香',
                'area_id' => $this->area['東京都'],
        ...
        foreach ($this->genre as $genre => $id) {
            Genre::create(['name' => $genre]);
        };
        foreach ($this->area as $area => $id) {
